...
def InceptionResNetV2():
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.17}, name='Block35_1_Lambda')(up)
	x = add([x, up], name='Block35_1_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.17}, name='Block35_2_Lambda')(up)
	x = add([x, up], name='Block35_2_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.17}, name='Block35_3_Lambda')(up)
	x = add([x, up], name='Block35_3_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.17}, name='Block35_4_Lambda')(up)
	x = add([x, up], name='Block35_4_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.17}, name='Block35_5_Lambda')(up)
	x = add([x, up], name='Block35_5_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1}, name='Block17_10_Lambda')(up)
	x = add([x, up], name='Block17_1_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1}, name='Block17_9_Lambda')(up)
	x = add([x, up], name='Block17_2_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1}, name='Block17_8_Lambda')(up)
	x = add([x, up], name='Block17_3_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1}, name='Block17_7_Lambda')(up)
	x = add([x, up], name='Block17_4_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1}, name='Block17_6_Lambda')(up)
	x = add([x, up], name='Block17_5_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1}, name='Block17_5_Lambda')(up)
	x = add([x, up], name='Block17_6_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1}, name='Block17_4_Lambda')(up)
	x = add([x, up], name='Block17_7_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1},name='Block17_3_Lambda')(up)
	x = add([x, up], name='Block17_8_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1}, name='Block17_2_Lambda')(up)
	x = add([x, up], name='Block17_9_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1}, name='Block17_1_Lambda')(up)
	x = add([x, up], name='Block17_10_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.2}, name='Block8_6_Lambda')(up)
	x = add([x, up], name='Block8_1_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.2}, name='Block8_5_Lambda')(up)
	x = add([x, up], name='Block8_2_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.2}, name='Block8_4_Lambda')(up)
	x = add([x, up], name='Block8_3_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.2}, name='Block8_3_Lambda')(up)
	x = add([x, up], name='Block8_4_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.2}, name='Block8_2_Lambda')(up)
	x = add([x, up], name='Block8_5_Add')
	...
	up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 1},name='Block8_1_Lambda')(up)
	x = add([x, up], name='Block8_6_Add')
